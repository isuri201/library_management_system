...
@endif
   ...
   <input type="date" name="pubdate" id="pubdate" class="form-control" value="{{$Book->publication_date}}">
   <label for="Publisher"> Publisher</label>
   <input type="text" name="publisher" class="form-control" id="Publisher" value="{{$Book->publisher}}">
   <label for="isbn">ISBN No</label>
   <input type="text" name="isbn" class="form-control" id="isbn" value="{{$Book->ISBN_No}}">
   <label for="image" >Image</label>
   <input type="file" name="image" class="form-control" id="image" value="{{$Book->image}}" >
   <img src="{{asset('uploads/'.$Book->image)}}" width="200" height="200"><br>
